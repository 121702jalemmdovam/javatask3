...
//   console.log(results.filter(item=>item.order.freight<1));

// 2)

//  console.log(results.filter(item=>item.order.customerId==="ERNSH"));
...
// console.log(results.find(item=>item.order.id===11075));
